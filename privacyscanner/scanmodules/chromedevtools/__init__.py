...
from privacyscanner.scanmodules.chromedevtools.extractors import FinalUrlExtractor, \
    ...
    HSTSPreloadExtractor, FingerprintingExtractor, GeneratorTagExtractor, SriExtractor, CookieSyncExtractor, \
...
EXTRACTOR_CLASSES = [FinalUrlExtractor, RedirectChainExtractor, GoogleAnalyticsExtractor,
                     ...
                     ImprintExtractor, HSTSPreloadExtractor, FingerprintingExtractor, GeneratorTagExtractor,
                     SriExtractor, CookieSyncExtractor, WhotracksmeExtractor]
